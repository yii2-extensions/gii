...
class Generator extends \yii\gii\Generator
{
    ...
    {
        if (!str_starts_with($this->controllerNamespace, (string) Yii::$app->controllerNamespace)) {
            return '';
        }
    ...
    public function getControllerSubPath()
    {
        ...
        if (str_starts_with($controllerNamespace, (string) Yii::$app->controllerNamespace)) {
            $subPath = substr($controllerNamespace, strlen((string) Yii::$app->controllerNamespace));
